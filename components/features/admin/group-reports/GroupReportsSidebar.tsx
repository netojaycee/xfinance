...
export default function GroupReportsSidebar({
  ...
  return (
    <aside className="w-64 min-w-55 bg-white rounded-2xl border border-[#F2F3F5] p-6 flex flex-col h-full">
      <div className="mb-6">
        <h2 className="text-lg font-bold text-indigo-900 mb-6">Scheduled Reports</h2>
