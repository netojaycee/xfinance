        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <div className="rounded-2xl bg-gray-50 p-2">
              <div className="grid grid-cols-5 md:grid-cols-10 gap-2 w-full mb-1">
                <div className="col-span-3 text-gray-400 font-medium text-xs">
                  Description
                </div>
                <div className="col-span-2 text-gray-400 font-medium text-center text-xs">
                  Qty
                </div>
                <div className="col-span-2 text-gray-400 font-medium text-center text-xs">
                  Unit Price
                ...
                <div className="col-span-1 text-center text-gray-400 font-medium text-xs">
                  Actions
                </div>
              </div>
              {fields.map((item, idx) => (
                <div
                  key={item.id}
                  className="grid grid-cols-5 md:grid-cols-10 gap-2 mb-2 items-center"
                >
                  <Controller
                    control={form.control}
          ...
          <div className="flex justify-end gap-2 border-t pt-4 pb-3">
            ...
            >
              ...
              {submitting ? "Please wait..." : "Create Receipt"}
            </Button>
          </div>
        </form>
      </Form>
