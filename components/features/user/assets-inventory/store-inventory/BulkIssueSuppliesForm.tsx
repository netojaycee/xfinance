...
const departments = ["IT", "Finance", "HR", "Admin", "Operations"];
...
export default function BulkIssueSuppliesForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const isoIssueDate = issueDate ? new Date(issueDate).toISOString() : undefined;
    onSubmit({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="bg-blue-50 rounded p-2">
        ...
        <div className="bg-[#f8fafc] rounded-2xl p-4 flex flex-col gap-4 max-h-64 overflow-y-auto">
