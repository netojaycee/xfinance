...
export const useCreateUser = (
  options?: UseMutationOptions<User[], Error, CreateSingleUserPayload | CreateBulkUsersPayload>
) => {
...
export const useUpdateUser = (
  options?: UseMutationOptions<User, Error, { userId: string; payload: UpdateUserPayload }>
) => {
  const queryClient = useQueryClient();
  const { closeModal } = useModal();
